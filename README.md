...
CI runs the full verification spine on every push: Rust tests, 130 keeper tests,
...
│   └── test/              #   130 tests incl. build-integrity guards on the pages,
...
| `keeper/` TS | ✅ 130 tests - trap logic, scaled classifier pinned to real account shapes, feed contract, page build integrity (including the static-fallback, alert-strip and provenance guards), Merkle parity, RPC parsing, base58, Pyth lane, 500-holder stress |
